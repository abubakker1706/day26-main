...
const Edit = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            await axios.put(`https://625bfd1cc9e78a8cb9b248ed.mockapi.io/admin/students/${params.id}`, values)
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                let user = await axios.get(`https://625bfd1cc9e78a8cb9b248ed.mockapi.io/admin/students/${params.id}`)
