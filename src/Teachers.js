...
const Teachers = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                let users = await axios.get("https://625bfd1cc9e78a8cb9b248ed.mockapi.io/admin/teachers")
    ...
    const deleteUser = (id) => {
        ...
        swal({
            ...
            if (willDelete) {
                axios.delete(`https://625bfd1cc9e78a8cb9b248ed.mockapi.io/admin/teachers/${id}`)
                    .then(() => {
                        getData();
                    });
    ...
    return (
        <><div className="container-fluid">
            ...
            {/* <!-- Page Heading --> */}
            <h1 className="h2 mb-0 text-gray-800">List Of Teachers</h1>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
               
                <Link to={"/createteachers"} type="button" className="d-none m-2 d-sm-inline-block btn btn-xs btn-primary shadow-sm"> Add Teachers</Link>
            </div>
